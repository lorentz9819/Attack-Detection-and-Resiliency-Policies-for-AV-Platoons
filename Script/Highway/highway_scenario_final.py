...
try:
    ...
    #---CARS SETUP---
    #****************
    spawn = carla.Transform(carla.Location(x=-9.2, y=-180.0, z=0.600000), carla.Rotation(pitch=0.000000, yaw=90, roll=0.000000))
    ...
    while True:
        ...
        with open('slead.txt','a') as f:
            print(slead, file = f)
        with open('sfol1.txt','a') as g:
            print(sfol1, file = g)
        with open('sfol2.txt','a') as h:
            print(sfol2, file = h)
        if y_lead > 222:
