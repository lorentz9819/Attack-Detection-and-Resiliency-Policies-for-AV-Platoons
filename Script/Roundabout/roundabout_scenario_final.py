...
try:
    ...
    #---CARS SETUP---
    #****************
    spawn = carla.Transform(carla.Location(x=35.9, y=-4.4, z=0.600000), carla.Rotation(pitch=0.000000, yaw=-180.000000, roll=0.000000))
    ...
    #---LANE INVASION SETUP---
    #*****************
    #lane_spawn = carla.Transform(carla.Location(x=2.5, z=0.8))
    #laneinv = blueprint_library.find('sensor.other.lane_invasion')
